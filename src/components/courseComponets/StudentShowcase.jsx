...
export default function StudentShowcase({projects}) {
    ...
    <section className="py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <Badge className="mb-4" data-testid="badge-showcase-status">Student Success Stories</Badge>
          <h2 className="text-4xl md:text-5xl font-bold font-[Poppins] mb-6" data-testid="text-showcase-title">
            Our <span className="text-primary">Alumni</span> Success
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Join hundreds of successful graduates who transformed their careers and now work at leading tech companies.
          </p>
        </div>
        ...
        {/* Student Projects */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center mb-8" data-testid="text-projects-title">
